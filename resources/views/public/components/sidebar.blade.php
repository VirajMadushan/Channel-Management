        ...
        <ul class="metismenu" id="menu">
                ...
                <a href="{{ route('dashboard') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <rect x="13" y="3" width="8" height="8" rx="1.5" fill="var(--primary)" opacity="0.4" />
                            <rect x="3" y="13" width="8" height="8" rx="1.5" fill="var(--primary)" opacity="0.4" />
                            <rect x="13" y="13" width="8" height="8" rx="1.5" fill="var(--primary)" opacity="0.4" />
                        </svg>
                    </div>
                ...
                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <rect x="9" y="13" width="6" height="8" rx="1" fill="white" opacity="0.6" />
                        </svg>
                    </div>
                ...
                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <rect x="6" y="12" width="5" height="4" rx="1" fill="white" opacity="0.6" />
                            <rect x="13" y="12" width="5" height="4" rx="1" fill="white" opacity="0.6" />
                        </svg>
                    </div>
            ...
            <li class="{{ request()->routeIs('channels', 'connect_channel') ? 'mm-active' : '' }}">
                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <circle cx="12" cy="12" r="9" stroke="#90959F" stroke-width="1.5" fill="none" />
                ...
                <a href="{{ route('rates') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <line x1="8" y1="2" x2="8" y2="6" stroke="#90959F" stroke-width="2" stroke-linecap="round" />
                            <line x1="16" y1="2" x2="16" y2="6" stroke="#90959F" stroke-width="2" stroke-linecap="round" />
                            <rect x="7" y="13" width="3" height="3" rx="0.5" fill="white" opacity="0.7" />
                            <rect x="12" y="13" width="3" height="3" rx="0.5" fill="white" opacity="0.7" />
                        </svg>
                    </div>
            ...
            {{-- Reservations --}}
            <li class="{{ request()->routeIs('reservations', 'booking') ? 'mm-active' : '' }}">
                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"
                                fill="#90959F" />
                            <rect x="9" y="3" width="6" height="4" rx="1" fill="#90959F" opacity="0.6" />
                ...
                <ul aria-expanded="false">
                    ...
                    <li class="{{ request()->routeIs('booking') ? 'mm-active' : '' }}">
                        <a href="{{ route('booking') }}">New Booking</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="{{ request()->routeIs('reports') ? 'mm-active' : '' }}">
                <a href="{{ route('reports') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <rect x="3" y="3" width="18" height="18" rx="2" fill="#90959F" opacity="0.15" />
