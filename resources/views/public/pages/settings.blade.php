...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="list-group list-group-flush rounded" id="settings-tabs">
                                    <a href="#tab-general"  class="list-group-item list-group-item-action active d-flex align-items-center gap-2 py-3" onclick="switchTab(this,'tab-general')"><i class="fa fa-cog text-primary"></i> General</a>
                                    <a href="#tab-api"      class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-3" onclick="switchTab(this,'tab-api')"><i class="fa fa-key text-warning"></i> API Keys</a>
                                    <a href="#tab-notif"    class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-3" onclick="switchTab(this,'tab-notif')"><i class="fa fa-bell text-success"></i> Notifications</a>
                                    <a href="#tab-user"     class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-3" onclick="switchTab(this,'tab-user')"><i class="fa fa-user text-info"></i> My Account</a>
                                    <a href="#tab-billing"  class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-3" onclick="switchTab(this,'tab-billing')"><i class="fa fa-credit-card text-danger"></i> Billing</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-9 col-md-8">
                        ...
                        <div id="tab-general">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6"><label class="form-label fw-bold">Company / Hotel Group Name</label><input type="text" class="form-control" value="Grand Hotel Group"></div>
                                        <div class="col-md-6"><label class="form-label fw-bold">System Email</label><input type="email" class="form-control" value="admin@grandhotelgroup.com"></div>
                                        <div class="col-md-6"><label class="form-label fw-bold">Default Currency</label><select class="form-control default-select"><option>USD — US Dollar</option><option>LKR — Sri Lankan Rupee</option><option>EUR — Euro</option><option>GBP — British Pound</option></select></div>
                                        <div class="col-md-6"><label class="form-label fw-bold">Timezone</label><select class="form-control default-select"><option>Asia/Colombo (UTC+5:30)</option><option>UTC</option><option>America/New_York</option><option>Europe/London</option></select></div>
                                        <div class="col-md-6"><label class="form-label fw-bold">Date Format</label><select class="form-control default-select"><option>DD/MM/YYYY</option><option>MM/DD/YYYY</option><option>YYYY-MM-DD</option></select></div>
                                        <div class="col-md-6"><label class="form-label fw-bold">Language</label><select class="form-control default-select"><option>English</option><option>Sinhala</option><option>Tamil</option></select></div>
                                        <div class="col-12"><label class="form-label fw-bold">System Logo</label><input type="file" class="form-control" accept="image/*"></div>
                                        <div class="col-12">
                                            <label class="form-label fw-bold">Sync Settings</label>
                                            <div class="row g-2">
                                                <div class="col-md-4"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" checked><label class="form-check-label">Auto-sync rates every 5 mins</label></div></div>
                                                <div class="col-md-4"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" checked><label class="form-check-label">Auto-sync availability</label></div></div>
                                                <div class="col-md-4"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" checked><label class="form-check-label">Auto-import reservations</label></div></div>
                                            </div>
                                        </div>
                                        <div class="col-12"><button class="btn btn-primary" onclick="saveSettings()"><i class="fa fa-save me-2"></i>Save General Settings</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="tab-api" style="display:none;">
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <h4 class="card-title"><i class="fa fa-key text-warning me-2"></i>API Keys &amp; Credentials</h4>
                                </div>
                                <div class="card-body">
        ...
        function switchTab(link, tabId) {
            ...
            document.querySelectorAll("#settings-tabs a").forEach(function(a){ a.classList.remove("active"); });
        ...
        function saveSettings() {
            ...
            btn.disabled = true;
            setTimeout(function(){ btn.innerHTML = '<i class="fa fa-check me-2"></i>Saved!'; setTimeout(function(){ btn.innerHTML=orig; btn.disabled=false; },2000); },1500);
        }
        </script>
@endsectionF